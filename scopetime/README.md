...
This crate is part of the [labtui](https://github.com/R5FR/labtui) project and can be used to annotate arbitrary scopes to `trace` their execution times via `log`:
