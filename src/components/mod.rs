/*!
Components are the visible building blocks in labtui.
...
In labtui, composition is driven by code. This means each component must
...
determine which code should be executed. This is not how labtui works.
