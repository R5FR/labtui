...
pub struct KeysList {
	...
	pub tab_merge_requests: GituiKeyEvent,
	pub tab_issues: GituiKeyEvent,
	pub tab_pipelines: GituiKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			tab_merge_requests: GituiKeyEvent::new(KeyCode::Char('6'),  KeyModifiers::empty()),
			tab_issues: GituiKeyEvent::new(KeyCode::Char('7'),  KeyModifiers::empty()),
			tab_pipelines: GituiKeyEvent::new(KeyCode::Char('8'),  KeyModifiers::empty()),
